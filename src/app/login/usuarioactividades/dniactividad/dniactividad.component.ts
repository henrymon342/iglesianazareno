...
@Component({
  selector: 'app-dniactividad',
  templateUrl: './dniactividad.component.html',
  styleUrls: ['./dniactividad.component.css']
})
export class DniactividadComponent implements OnInit {
  ...
  getActividadesDni() {
    const tipo_de_ministerio = { ministerio: 'DNI'}
